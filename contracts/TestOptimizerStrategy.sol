...
import "./IYieldContract.sol";
import "./TestOptimizerStrategyManager.sol";

contract TestOptimizerStrategy is TestOptimizerStrategyManager {
     ...
     */
    constructor(address _yieldContract) OptimizerStrategyManager() public {
